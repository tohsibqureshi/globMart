...
<div class="container">
	<div class="row">
		<form class="form-horizontal" action="/paymentaddaddress">
			<fieldset>
				<!-- Address form -->
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="full-name" name="fullname" type="text" required="required"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="full-name" name="email" type="email" required="required"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="full-name" name="phone" type="text" required="required"
							placeholder="Enter Mobile No." class="input-xlarge">
						<p class="help-block"></p>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="full-name" name="username" type="text" required="required"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="full-name" name="password" type="password" required="required"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="postal-code" name="postalcode" type="text"
